...
void Sqlite3Lexer::initLiterals()
{
	...
	literals["END"] = 29;
	literals["CASCADE"] = 12;
	literals["TEMPORARY"] = 67;
	literals["RANGE"] = 58;
	literals["DEFERRABLE"] = 24;
	literals["IMMEDIATE"] = 45;
	...
	literals["TEMP"] = 68;
	literals["OVER"] = 53;
	literals["INITIALLY"] = 43;
	literals["RESTRICT"] = 62;
	literals["LIKE"] = 37;
	literals["WHEN"] = 75;
	literals["FOREIGN"] = 34;
	literals["SET"] = 66;
	...
	literals["UPDATE"] = 72;
	literals["IF"] = 39;
	literals["PRECEDING"] = 55;
	literals["UNIQUE"] = 71;
	literals["AS"] = 7;
	literals["TABLE"] = 38;
	literals["UNBOUNDED"] = 70;
	literals["DEFAULT"] = 23;
	literals["ACTION"] = 5;
	literals["DELETE"] = 26;
	literals["GLOB"] = 35;
	literals["FOLLOWING"] = 33;
	literals["IGNORE"] = 40;
	literals["INSERT"] = 44;
...
void Sqlite3Lexer::mSLASH(bool _createToken) {
	int _ttype; ANTLR_USE_NAMESPACE(antlr)RefToken _token; ANTLR_USE_NAMESPACE(std)string::size_type _begin = text.length();
	_ttype = SLASH;
	ANTLR_USE_NAMESPACE(std)string::size_type _saveIndex;
