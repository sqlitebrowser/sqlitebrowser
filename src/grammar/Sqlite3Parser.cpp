...
void Sqlite3Parser::subexpr() {
	...
	default:
		if ((LA(1) == MINUS) && (_tokenSet_12.member(LA(2)))) {
		...
		else if ((LA(1) == PLUS) && (_tokenSet_12.member(LA(2)))) {
		...
		else if ((_tokenSet_12.member(LA(1))) && (_tokenSet_6.member(LA(2)))) {
		}
	else {
		throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
	}
	...
	case LPAREN:
	{
		...
		match(LPAREN);
		{
		if ((_tokenSet_13.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == COMMA)) {
			{
			{
			if ((_tokenSet_7.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == COMMA)) {
				literalvalue();
				if (inputState->guessing==0) {
					astFactory->addASTChild( currentAST, returnAST );
				}
			...
			for (;;) {
				if ((LA(1) == COMMA)) {
					...
					match(COMMA);
					{
					if ((_tokenSet_7.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == RPAREN || LA(2) == COMMA)) {
						literalvalue();
						if (inputState->guessing==0) {
							astFactory->addASTChild( currentAST, returnAST );
						}
					}
					else if ((_tokenSet_2.member(LA(1))) && (LA(2) == RPAREN || LA(2) == COMMA)) {
						columnname();
						if (inputState->guessing==0) {
							astFactory->addASTChild( currentAST, returnAST );
						}
	...
	default:
		if ((_tokenSet_7.member(LA(1))) && (_tokenSet_15.member(LA(2)))) {
		...
		else if ((_tokenSet_2.member(LA(1))) && (_tokenSet_16.member(LA(2)))) {
			{
			...
			else if ((_tokenSet_2.member(LA(1))) && (_tokenSet_17.member(LA(2)))) {
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
			}
...
void Sqlite3Parser::suffixexpr() {
	...
	case REGEXP:
	{
		...
		case REGEXP:
		{
			...
			{
			if ((LA(1) == ESCAPE) && (_tokenSet_5.member(LA(2)))) {
...
const unsigned long Sqlite3Parser::_tokenSet_2_data_[] = { 2859749680UL, 4142180795UL, 234890331UL, 1UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_3_data_[] = { 9076736UL, 151191552UL, 128UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_4_data_[] = { 1536UL, 268714024UL, 0UL, 25165536UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_5_data_[] = { 2859757872UL, 4142901691UL, 503325787UL, 355UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_6_data_[] = { 4202070002UL, 4142918587UL, 520105083UL, 25165807UL, 0UL, 0UL, 0UL, 0UL };
...
// PLUS MINUS STAR TILDE AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 GREATER 
...
const unsigned long Sqlite3Parser::_tokenSet_7_data_[] = { 7340032UL, 131072UL, 268435456UL, 97UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_8_data_[] = { 9076736UL, 151191552UL, 268435584UL, 12UL, 0UL, 0UL, 0UL, 0UL };
// "CHECK" "COLLATE" "CONSTRAINT" "DEFAULT" "NOT" "NULL" "PRIMARY" "REFERENCES" 
// "UNIQUE" NUMERIC RPAREN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_8(_tokenSet_8_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_9_data_[] = { 3128185136UL, 4142180667UL, 9307UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" 
...
const unsigned long Sqlite3Parser::_tokenSet_10_data_[] = { 9076736UL, 151191552UL, 128UL, 12UL, 0UL, 0UL, 0UL, 0UL };
// "CHECK" "COLLATE" "CONSTRAINT" "DEFAULT" "NOT" "NULL" "PRIMARY" "REFERENCES" 
// "UNIQUE" RPAREN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_10(_tokenSet_10_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_11_data_[] = { 3137261874UL, 4294420927UL, 503325915UL, 111UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_12_data_[] = { 2859757872UL, 4142836155UL, 503325787UL, 99UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CASE" "CAST" "CONFLICT" "CURRENT_TIME" 
// "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" 
// "FOLLOWING" "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" 
...
const unsigned long Sqlite3Parser::_tokenSet_13_data_[] = { 2859749680UL, 4142311867UL, 503325787UL, 97UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" 
// "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" "FOLLOWING" 
...
const unsigned long Sqlite3Parser::_tokenSet_14_data_[] = { 2859892528UL, 4142918587UL, 520105051UL, 25165799UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_15_data_[] = { 2013401026UL, 268780072UL, 268437536UL, 25165548UL, 0UL, 0UL, 0UL, 0UL };
// EOF "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" 
// "ELSE" "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" 
// "THEN" "WHEN" NUMERIC RPAREN COMMA PLUS MINUS STAR AMPERSAND PERCENT 
...
const unsigned long Sqlite3Parser::_tokenSet_16_data_[] = { 2013401026UL, 268780072UL, 16779296UL, 25165548UL, 0UL, 0UL, 0UL, 0UL };
// EOF "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" 
// "ELSE" "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" 
// "THEN" "WHEN" DOT RPAREN COMMA PLUS MINUS STAR AMPERSAND PERCENT BITOR 
...
const unsigned long Sqlite3Parser::_tokenSet_17_data_[] = { 2013401026UL, 268780072UL, 2080UL, 25165548UL, 0UL, 0UL, 0UL, 0UL };
// EOF "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" 
// "ELSE" "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" 
// "THEN" "WHEN" RPAREN COMMA PLUS MINUS STAR AMPERSAND PERCENT BITOR OROP 
...
const unsigned long Sqlite3Parser::_tokenSet_18_data_[] = { 133120UL, 268763688UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_19_data_[] = { 2859759920UL, 4142902203UL, 503325787UL, 355UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_20_data_[] = { 2013398978UL, 268714024UL, 2080UL, 25165548UL, 0UL, 0UL, 0UL, 0UL };
// EOF "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "COLLATE" "DESC" "ELSE" "END" 
// "ESCAPE" "GLOB" "LIKE" "IS" "MATCH" "REGEXP" "THEN" "WHEN" RPAREN COMMA 
// PLUS MINUS STAR AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 GREATER GREATEREQUAL 
// LOWER LOWEREQUAL UNEQUAL UNEQUAL2 BITWISELEFT BITWISERIGHT SLASH 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_20(_tokenSet_20_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_21_data_[] = { 4211015666UL, 4294962107UL, 503332091UL, 25165807UL, 0UL, 0UL, 0UL, 0UL };
// EOF "ABORT" "ACTION" "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" 
...
// COMMA PLUS MINUS STAR TILDE AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 
...
const unsigned long Sqlite3Parser::_tokenSet_22_data_[] = { 1024UL, 268714024UL, 0UL, 25165536UL, 0UL, 0UL, 0UL, 0UL };
