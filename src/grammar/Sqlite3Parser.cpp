/* $ANTLR 2.7.7 (20171109): "sqlite3.g" -> "Sqlite3Parser.cpp"$ */
...
void Sqlite3Parser::createtable() {
	...
	if ((LA(1) == CREATE) && (LA(2) == TABLE || LA(2) == TEMPORARY || LA(2) == TEMP)) {
		...
		{ // ( ... )*
		for (;;) {
			if ((LA(1) == COMMA) && (_tokenSet_0.member(LA(2)))) {
...
void Sqlite3Parser::subexpr() {
	...
	default:
		if ((LA(1) == MINUS) && (_tokenSet_10.member(LA(2)))) {
		...
		else if ((LA(1) == PLUS) && (_tokenSet_10.member(LA(2)))) {
		...
		else if ((_tokenSet_10.member(LA(1))) && (_tokenSet_4.member(LA(2)))) {
		}
	else {
		throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
	}
	...
	case LPAREN:
	{
		...
		match(LPAREN);
		{
		if ((_tokenSet_11.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == COMMA)) {
			{
			{
			if ((_tokenSet_5.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == COMMA)) {
				literalvalue();
				if (inputState->guessing==0) {
					astFactory->addASTChild( currentAST, returnAST );
				}
			}
			else if ((_tokenSet_0.member(LA(1))) && (LA(2) == COMMA)) {
				columnname();
				if (inputState->guessing==0) {
					astFactory->addASTChild( currentAST, returnAST );
				}
			...
			for (;;) {
				if ((LA(1) == COMMA)) {
					...
					match(COMMA);
					{
					if ((_tokenSet_5.member(LA(1))) && (LA(2) == NUMERIC || LA(2) == RPAREN || LA(2) == COMMA)) {
						literalvalue();
						if (inputState->guessing==0) {
							astFactory->addASTChild( currentAST, returnAST );
						}
					}
					else if ((_tokenSet_0.member(LA(1))) && (LA(2) == RPAREN || LA(2) == COMMA)) {
						columnname();
						if (inputState->guessing==0) {
							astFactory->addASTChild( currentAST, returnAST );
						}
		...
		else if ((_tokenSet_3.member(LA(1))) && (_tokenSet_12.member(LA(2)))) {
			expr();
			if (inputState->guessing==0) {
				astFactory->addASTChild( currentAST, returnAST );
			}
	...
	default:
		if ((_tokenSet_5.member(LA(1))) && (_tokenSet_13.member(LA(2)))) {
		...
		else if ((_tokenSet_0.member(LA(1))) && (_tokenSet_14.member(LA(2)))) {
			{
			if ((_tokenSet_15.member(LA(1))) && (LA(2) == DOT)) {
				{
				if ((_tokenSet_15.member(LA(1))) && (LA(2) == DOT)) {
					databasename();
					if (inputState->guessing==0) {
				...
				else if ((_tokenSet_15.member(LA(1))) && (LA(2) == DOT)) {
				}
				else {
					throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
				}
			...
			else if ((_tokenSet_0.member(LA(1))) && (_tokenSet_16.member(LA(2)))) {
			}
			else {
				throw ANTLR_USE_NAMESPACE(antlr)NoViableAltException(LT(1), getFilename());
			}
		...
		else if ((_tokenSet_15.member(LA(1))) && (LA(2) == LPAREN)) {
			functionname();
			if (inputState->guessing==0) {
				astFactory->addASTChild( currentAST, returnAST );
			}
...
void Sqlite3Parser::suffixexpr() {
	...
	case REGEXP:
	{
		...
		case REGEXP:
		{
			...
			{
			if ((LA(1) == ESCAPE) && (_tokenSet_3.member(LA(2)))) {
...
const unsigned long Sqlite3Parser::_tokenSet_0_data_[] = { 2859749680UL, 4142180795UL, 2264933467UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" 
// "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" "FOLLOWING" 
// "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" "NO" "MATCH" 
// "OVER" "PARTITION" "PRECEDING" "RAISE" "RANGE" "REGEXP" "REPLACE" "RESTRICT" 
// "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" "VIRTUAL" "WITHOUT" 
...
const unsigned long Sqlite3Parser::_tokenSet_1_data_[] = { 9076736UL, 151191552UL, 128UL, 0UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_2_data_[] = { 1536UL, 268714024UL, 0UL, 8388336UL, 0UL, 0UL, 0UL, 0UL };
// "AND" "OR" "GLOB" "LIKE" "IS" "MATCH" "REGEXP" PLUS MINUS STAR SLASH 
// AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 GREATER GREATEREQUAL LOWER 
// LOWEREQUAL UNEQUAL UNEQUAL2 BITWISELEFT BITWISERIGHT 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_2(_tokenSet_2_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_3_data_[] = { 2859757872UL, 4142901691UL, 2399151195UL, 305UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CASE" "CAST" "CONFLICT" "CURRENT_TIME" 
// "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" 
// "FOLLOWING" "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" 
// "NO" "NOT" "NULL" "MATCH" "EXISTS" "OVER" "PARTITION" "PRECEDING" "RAISE" 
// "RANGE" "REGEXP" "REPLACE" "RESTRICT" "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" 
// "TEMP" "UNBOUNDED" "VIRTUAL" "WITHOUT" ID QUOTEDID QUOTEDLITERAL NUMERIC 
// STRINGLITERAL LPAREN PLUS MINUS TILDE 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_3(_tokenSet_3_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_4_data_[] = { 4202070000UL, 4142918587UL, 2407541883UL, 8388599UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "CASCADE" 
// "CASE" "CAST" "COLLATE" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" "CURRENT_TIMESTAMP" 
// "DEFERRED" "DESC" "ELSE" "END" "ESCAPE" "FAIL" "FILTER" "FOLLOWING" 
// "GLOB" "KEY" "LIKE" "IF" "IGNORE" "IN" "INITIALLY" "IMMEDIATE" "IS" 
// "NO" "NOT" "NULL" "MATCH" "EXISTS" "OVER" "PARTITION" "PRECEDING" "RAISE" 
// "RANGE" "REGEXP" "REPLACE" "RESTRICT" "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" 
// "TEMP" "THEN" "UNBOUNDED" "VIRTUAL" "WHEN" "WITHOUT" DOT ID QUOTEDID 
// QUOTEDLITERAL NUMERIC STRINGLITERAL LPAREN RPAREN COMMA PLUS MINUS STAR 
// SLASH TILDE AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 GREATER GREATEREQUAL 
// LOWER LOWEREQUAL UNEQUAL UNEQUAL2 BITWISELEFT BITWISERIGHT 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_4(_tokenSet_4_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_5_data_[] = { 7340032UL, 131072UL, 2281701376UL, 48UL, 0UL, 0UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_6_data_[] = { 9076736UL, 151191552UL, 134217856UL, 6UL, 0UL, 0UL, 0UL, 0UL };
// "CHECK" "COLLATE" "CONSTRAINT" "DEFAULT" "NOT" "NULL" "PRIMARY" "REFERENCES" 
// "UNIQUE" NUMERIC RPAREN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_6(_tokenSet_6_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_7_data_[] = { 3128185136UL, 4142180667UL, 9307UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" 
// "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "ELSE" "END" "FAIL" "FILTER" "FOLLOWING" 
// "GLOB" "KEY" "LIKE" "IGNORE" "INITIALLY" "IMMEDIATE" "NO" "MATCH" "OVER" 
// "PARTITION" "PRECEDING" "RAISE" "RANGE" "REGEXP" "REPLACE" "RESTRICT" 
// "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" "VIRTUAL" "WITHOUT" 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_7(_tokenSet_7_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_8_data_[] = { 9076736UL, 151191552UL, 128UL, 6UL, 0UL, 0UL, 0UL, 0UL };
// "CHECK" "COLLATE" "CONSTRAINT" "DEFAULT" "NOT" "NULL" "PRIMARY" "REFERENCES" 
// "UNIQUE" RPAREN COMMA 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_8(_tokenSet_8_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_9_data_[] = { 3137261874UL, 4294420927UL, 2399151323UL, 63UL, 0UL, 0UL, 0UL, 0UL };
// EOF "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CHECK" "COLLATE" "CONFLICT" 
// "CONSTRAINT" "CURRENT_TIME" "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFAULT" 
// "DEFERRED" "DESC" "ELSE" "END" "FAIL" "FILTER" "FOLLOWING" "FOREIGN" 
// "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" "NO" "NOT" 
// "NULL" "MATCH" "ON" "OVER" "PARTITION" "PRECEDING" "PRIMARY" "RAISE" 
// "RANGE" "REFERENCES" "REGEXP" "REPLACE" "RESTRICT" "ROLLBACK" "ROWID" 
// "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" "UNIQUE" "VIRTUAL" "WITHOUT" ID 
// QUOTEDID QUOTEDLITERAL NUMERIC STRINGLITERAL LPAREN RPAREN COMMA SEMI 
// PLUS MINUS 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_9(_tokenSet_9_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_10_data_[] = { 2859757872UL, 4142836155UL, 2399151195UL, 49UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CASE" "CAST" "CONFLICT" "CURRENT_TIME" 
// "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" 
// "FOLLOWING" "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" 
// "NO" "NULL" "MATCH" "EXISTS" "OVER" "PARTITION" "PRECEDING" "RAISE" 
// "RANGE" "REGEXP" "REPLACE" "RESTRICT" "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" 
// "TEMP" "UNBOUNDED" "VIRTUAL" "WITHOUT" ID QUOTEDID QUOTEDLITERAL NUMERIC 
// STRINGLITERAL LPAREN PLUS MINUS 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_10(_tokenSet_10_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_11_data_[] = { 2859749680UL, 4142311867UL, 2399151195UL, 48UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "CASCADE" "CAST" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" 
// "CURRENT_TIMESTAMP" "DEFERRED" "DESC" "END" "FAIL" "FILTER" "FOLLOWING" 
// "GLOB" "KEY" "LIKE" "IF" "IGNORE" "INITIALLY" "IMMEDIATE" "NO" "NULL" 
// "MATCH" "OVER" "PARTITION" "PRECEDING" "RAISE" "RANGE" "REGEXP" "REPLACE" 
// "RESTRICT" "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" 
// "VIRTUAL" "WITHOUT" ID QUOTEDID QUOTEDLITERAL NUMERIC STRINGLITERAL 
// PLUS MINUS 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_11(_tokenSet_11_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_12_data_[] = { 2859892528UL, 4142918587UL, 2407541851UL, 8388595UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "AND" "OR" "BETWEEN" "CASCADE" "CASE" "CAST" 
// "COLLATE" "CONFLICT" "CURRENT_TIME" "CURRENT_DATE" "CURRENT_TIMESTAMP" 
// "DEFERRED" "DESC" "END" "FAIL" "FILTER" "FOLLOWING" "GLOB" "KEY" "LIKE" 
// "IF" "IGNORE" "IN" "INITIALLY" "IMMEDIATE" "IS" "NO" "NOT" "NULL" "MATCH" 
// "EXISTS" "OVER" "PARTITION" "PRECEDING" "RAISE" "RANGE" "REGEXP" "REPLACE" 
// "RESTRICT" "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" 
// "VIRTUAL" "WHEN" "WITHOUT" DOT ID QUOTEDID QUOTEDLITERAL NUMERIC STRINGLITERAL 
// LPAREN RPAREN PLUS MINUS STAR SLASH TILDE AMPERSAND PERCENT BITOR OROP 
...
const unsigned long Sqlite3Parser::_tokenSet_13_data_[] = { 2013401024UL, 268780072UL, 134219808UL, 8388342UL, 0UL, 0UL, 0UL, 0UL };
// "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" "ELSE" 
// "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" "THEN" 
// "WHEN" NUMERIC RPAREN COMMA PLUS MINUS STAR SLASH AMPERSAND PERCENT 
// BITOR OROP EQUAL EQUAL2 GREATER GREATEREQUAL LOWER LOWEREQUAL UNEQUAL 
// UNEQUAL2 BITWISELEFT BITWISERIGHT 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_13(_tokenSet_13_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_14_data_[] = { 2013401024UL, 268780072UL, 8390688UL, 8388342UL, 0UL, 0UL, 0UL, 0UL };
// "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" "ELSE" 
// "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" "THEN" 
// "WHEN" DOT RPAREN COMMA PLUS MINUS STAR SLASH AMPERSAND PERCENT BITOR 
...
const unsigned long Sqlite3Parser::_tokenSet_15_data_[] = { 0UL, 0UL, 2264924160UL, 0UL, 0UL, 0UL, 0UL, 0UL };
// ID QUOTEDID QUOTEDLITERAL STRINGLITERAL 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_15(_tokenSet_15_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_16_data_[] = { 2013401024UL, 268780072UL, 2080UL, 8388342UL, 0UL, 0UL, 0UL, 0UL };
// "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" "COLLATE" "DESC" "ELSE" 
// "END" "ESCAPE" "GLOB" "LIKE" "IN" "IS" "NOT" "MATCH" "REGEXP" "THEN" 
// "WHEN" RPAREN COMMA PLUS MINUS STAR SLASH AMPERSAND PERCENT BITOR OROP 
// EQUAL EQUAL2 GREATER GREATEREQUAL LOWER LOWEREQUAL UNEQUAL UNEQUAL2 
// BITWISELEFT BITWISERIGHT 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_16(_tokenSet_16_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_17_data_[] = { 133120UL, 268763688UL, 0UL, 0UL };
...
const unsigned long Sqlite3Parser::_tokenSet_18_data_[] = { 2859759920UL, 4142902203UL, 2399151195UL, 305UL, 0UL, 0UL, 0UL, 0UL };
// "ABORT" "ACTION" "ASC" "BETWEEN" "CASCADE" "CASE" "CAST" "CONFLICT" 
// "CURRENT_TIME" "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFERRED" "DESC" 
// "END" "FAIL" "FILTER" "FOLLOWING" "GLOB" "KEY" "LIKE" "IF" "IGNORE" 
// "IN" "INITIALLY" "IMMEDIATE" "NO" "NOT" "NULL" "MATCH" "EXISTS" "OVER" 
// "PARTITION" "PRECEDING" "RAISE" "RANGE" "REGEXP" "REPLACE" "RESTRICT" 
// "ROLLBACK" "ROWID" "ROWS" "TEMPORARY" "TEMP" "UNBOUNDED" "VIRTUAL" "WITHOUT" 
// ID QUOTEDID QUOTEDLITERAL NUMERIC STRINGLITERAL LPAREN PLUS MINUS TILDE 
const ANTLR_USE_NAMESPACE(antlr)BitSet Sqlite3Parser::_tokenSet_18(_tokenSet_18_data_,8);
const unsigned long Sqlite3Parser::_tokenSet_19_data_[] = { 2013398976UL, 268714024UL, 2080UL, 8388342UL, 0UL, 0UL, 0UL, 0UL };
// "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "COLLATE" "DESC" "ELSE" "END" 
// "ESCAPE" "GLOB" "LIKE" "IS" "MATCH" "REGEXP" "THEN" "WHEN" RPAREN COMMA 
// PLUS MINUS STAR SLASH AMPERSAND PERCENT BITOR OROP EQUAL EQUAL2 GREATER 
...
const unsigned long Sqlite3Parser::_tokenSet_20_data_[] = { 4211015666UL, 4294962107UL, 2399153403UL, 8388607UL, 0UL, 0UL, 0UL, 0UL };
// EOF "ABORT" "ACTION" "AUTOINCREMENT" "AS" "ASC" "AND" "OR" "BETWEEN" 
// "CASCADE" "CASE" "CAST" "CHECK" "COLLATE" "CONFLICT" "CONSTRAINT" "CURRENT_TIME" 
// "CURRENT_DATE" "CURRENT_TIMESTAMP" "DEFAULT" "DEFERRED" "DESC" "ELSE" 
// "END" "ESCAPE" "FAIL" "FILTER" "FOLLOWING" "GLOB" "KEY" "LIKE" "IF" 
// "IGNORE" "IN" "INITIALLY" "IMMEDIATE" "IS" "NO" "NOT" "NULL" "MATCH" 
// "EXISTS" "ON" "OVER" "PARTITION" "PRECEDING" "PRIMARY" "RAISE" "RANGE" 
// "REFERENCES" "REGEXP" "REPLACE" "RESTRICT" "ROLLBACK" "ROWID" "ROWS" 
// "TEMPORARY" "TEMP" "THEN" "UNBOUNDED" "UNIQUE" "VIRTUAL" "WHEN" "WITHOUT" 
// ID QUOTEDID QUOTEDLITERAL NUMERIC STRINGLITERAL LPAREN RPAREN COMMA 
// SEMI PLUS MINUS STAR SLASH TILDE AMPERSAND PERCENT BITOR OROP EQUAL 
...
const unsigned long Sqlite3Parser::_tokenSet_21_data_[] = { 1024UL, 268714024UL, 0UL, 8388336UL, 0UL, 0UL, 0UL, 0UL };
// "OR" "GLOB" "LIKE" "IS" "MATCH" "REGEXP" PLUS MINUS STAR SLASH AMPERSAND 
// PERCENT BITOR OROP EQUAL EQUAL2 GREATER GREATEREQUAL LOWER LOWEREQUAL 
// UNEQUAL UNEQUAL2 BITWISELEFT BITWISERIGHT 
