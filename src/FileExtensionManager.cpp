...
FileExtensionManager::FileExtensionManager( QWidget *parent ) :
    QDialog(parent),
    ui(new Ui::FileExtensionManager)
{
    ui->setupUi(this);

    QStringList currentList = FileDialog::getSqlDatabaseFileFilter().split(";;");
    int i = 0;
    foreach( QString itemString, currentList )
    {
...
QStringList FileExtensionManager::getDBFileExtesions()
{
    QStringList result;
