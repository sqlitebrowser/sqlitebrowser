...
## [3.11.3](https://github.com/nlohmann/json/releases/tag/3.11.3) (2023-11-28)

[Full Changelog](https://github.com/nlohmann/json/compare/v3.11.2...3.11.3)

- Allow [**custom base class**](https://json.nlohmann.me/api/basic_json/json_base_class_t/) as node customization point. This adds an additional template parameter which allows to set a custom base class for `nlohmann::json`. This class serves as an extension point and allows to add functionality to json node. Examples for such functionality might be metadata or additional member functions (e.g., visitors) or other application specific code. By default the parameter is set to `void` and an empty base class is used. In this case the library behaves as it already did. [#3110](https://github.com/nlohmann/json/pull/3110)
- Add more specific parse error message when attempting to **parse empty input**. [#4037](https://github.com/nlohmann/json/issues/4037) [#4180](https://github.com/nlohmann/json/pull/4180)
- Add serialization-only user defined type [**macros**](https://json.nlohmann.me/features/macros/) (`NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_ONLY_SERIALIZE` and `NLOHMANN_DEFINE_TYPE_INTRUSIVE_ONLY_SERIALIZE`). [#3816](https://github.com/nlohmann/json/pull/3816)
- Add **Bazel** build support. If you are using [Bazel](https://bazel.build/) you can simply reference this repository using `http_archive` or `git_repository` and depend on `@nlohmann_json//:json`. [#3709](https://github.com/nlohmann/json/pull/3709)
- Support Apple's Swift Package Manager. [#4010](https://github.com/nlohmann/json/pull/4010)

- Adjust CMake files to accept `NEW` **CMake policies** up to CMake 3.14. This fixes a nasty deprecation warning that "Compatibility with CMake < 3.5 will be removed from a future version of CMake". [#4076](https://github.com/nlohmann/json/issues/4076) [#4112](https://github.com/nlohmann/json/pull/4112)
- Fix CMake header path in install with custom `CMAKE_INSTALL_INCLUDEDIR`. [#4194](https://github.com/nlohmann/json/pull/4194)
- Add missing `<numeric>` header include. [#3717](https://github.com/nlohmann/json/issues/3717) [#3718](https://github.com/nlohmann/json/pull/3718) [#3719](https://github.com/nlohmann/json/pull/3719)
- Replace uses of `INT_MIN`/`INT_MAX`, etc. with `std::numeric_limits` and consistently use `std`\-namespaced integer types to make library work with newer GCC versions. [#3722](https://github.com/nlohmann/json/issues/3722) [#3723](https://github.com/nlohmann/json/pull/3723)
- Add missing files (`json_fwd.hpp` and Bazel build files) to release artifact `include.zip`. [#3727](https://github.com/nlohmann/json/issues/3727) [#3728](https://github.com/nlohmann/json/pull/3728)
- Fix 'declaration hides global declaration' warning. [#3751](https://github.com/nlohmann/json/pull/3751)
- Fix natvis XML. [#3858](https://github.com/nlohmann/json/issues/3858) [#3863](https://github.com/nlohmann/json/pull/3863)
- Fix warning about moved from object. [#3805](https://github.com/nlohmann/json/issues/3805) [#3889](https://github.com/nlohmann/json/pull/3889)
- Remove a magic number to fix a warning. [#3837](https://github.com/nlohmann/json/issues/3837) [#3888](https://github.com/nlohmann/json/pull/3888)
- Fix debug pretty-printer by checking if match is valid before accessing group. [#3919](https://github.com/nlohmann/json/issues/3919) [#3920](https://github.com/nlohmann/json/pull/3920)
- Fix custom allocators by defining missing `rebind` type. [#3895](https://github.com/nlohmann/json/pull/3895) [#3927](https://github.com/nlohmann/json/issues/3927)
- Prevent memory leak when exception is thrown in `adl_serializer::to_json` [#3881](https://github.com/nlohmann/json/issues/3881) [#3901](https://github.com/nlohmann/json/pull/3901)
- Fix Clang-Tidy warnings. [#4047](https://github.com/nlohmann/json/pull/4047)
- Fix init-list construction when `size_type` is not `int`. [#4140](https://github.com/nlohmann/json/pull/4140)
- Fix deprecation warning "identifier `_json` preceded by whitespace in a literal operator declaration". [#4129](https://github.com/nlohmann/json/issues/4129) [#4161](https://github.com/nlohmann/json/pull/4161)
- Fix compile error with `_HAS_STATIC_RTTI=0`. [#4046](https://github.com/nlohmann/json/pull/4046)
- Fix char\_traits deprecation warning "`char_traits<unsigned char>` is deprecated: `char_traits<T>` for `T` not equal to `char`, `wchar_t`, `char8_t`, `char16_t` or `char32_t` is non-standard". [#4163](https://github.com/nlohmann/json/issues/4163) [#4179](https://github.com/nlohmann/json/pull/4179)
